...
dir_name = 'All_balanced_low_var_0.001'
classification_type = dir_name.split('_')[0]
balanced = dir_name.split('_')[1]

input_dir = '/Machine_Learning_Outputs/White_Blood_Cells/Cross_Validation/' + dir_name
output_dir = '/Machine_Learning_Outputs/White_Blood_Cells/Cross_Validation_Readouts/' + dir_name
